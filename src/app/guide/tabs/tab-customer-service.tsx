  ...
  return (
    <div className="space-y-4">
      <SectionCard title="🎁 프로모션 안내 기준">
        ...
        />
        <div className="mt-3">
          <Alert type="info">수량 할인(8대↑ 5%·12대↑ 10%)·일시불 할인은 <strong>가격·결제 탭</strong> 참조. 3대 이하에는 프로모션을 제시하지 않는다</Alert>
        </div>
      </SectionCard>
      ...
      <SectionCard title="❓ 자주 묻는 질문 (FAQ)">
        ...
        <FaqItem q="영상은 얼마나 오래 저장되나요?" a="키퍼는 대수에 맞는 고용량 전용 저장장치를 기본으로 제공합니다(4채널까지 4TB, 5~8채널 6TB, 9~16채널 10TB). 일반적인 CCTV보다 훨씬 긴 30일간의 영상을 안전하게 저장할 수 있어, 뒤늦게 발견된 이슈도 확실하게 확인 가능합니다." />
        ...
        <FaqItem q="무상 A/S는 어떻게 되나요?" a={<>제조사인 한화비전이 직접 품질을 보증하며 3년간 무상 A/S를 제공합니다. 설치 후 30일 이내에는 사유와 관계없이 전액 무료로 처리해 드립니다.<br/>접수: 고객만족센터 1670-5772 또는 앱 내 1:1 문의</>} />
        <FaqItem q="안심케어 보험은 어떤 혜택인가요?" a="구매 후 1년간 한화비전이 보험료를 전액 부담하는 무료 보험 혜택입니다. 비품 파손, 개인정보 유출, 영업 배상까지 최대 1,000만 원을 보장해 드립니다." />
        ...
        <FaqItem q="제품 탈부착이 자유롭게 가능한가요?" a="고정형으로 설치됩니다. 이전 설치가 필요하신 경우 고객만족센터(1670-5772)로 연락해 주세요." />
        ...
        <FaqItem q="법인카드 결제나 무통장 입금도 가능한가요?" a={<>법인카드로 <strong>일시불 결제</strong>는 앱·네이버 스마트스토어 모두 가능합니다. 다만 카드사 정책상 <strong>법인카드는 36개월 무이자 할부가 되지 않습니다</strong>. 무통장 입금은 네이버 스마트스토어에서만 가능합니다.</>} />
