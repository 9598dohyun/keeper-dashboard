    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-4">
      ...
      {t.상담차수 && t.상담차수.결제 > 0 && (
        ...
        >
          ...
          {/*
            첫응대시각은 2026-08-11부터 쌓여 그 이전 유입분은 값이 없다.
            값이 없으면 첫상담 조건을 만족할 수 없어 재상담으로 떨어지므로, 재상담이
            과다 집계된 규모를 숨기지 않고 함께 적는다.
          */}
          <div className="mt-3 space-y-1 text-xs text-gray-500">
            ...
            */}
            ...
            {t.상담차수.첫응대시각없음 > 0 && (
              <p>
                재상담 {t.상담차수.재상담}건 중 {t.상담차수.첫응대시각없음}건은 첫응대 기록이 없어
                재상담으로 분류된 건이다(첫응대 기록은 2026-08-11부터 쌓임). 실제 재상담 주문은
                이보다 적을 수 있다.
              </p>
            )}
          </div>
