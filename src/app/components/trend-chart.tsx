  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border p-4 space-y-4">
        <div>
          <div className="text-xs text-gray-500 mb-1">결제율 / 응대율 / 부재율 (%)</div>
          <ResponsiveContainer width="100%" height={180}>
            <LineChart data={chartData}>
              ...
              <Line type="monotone" dataKey="전환율" stroke="#22c55e" strokeWidth={2} dot={{ r: 3 }} name="결제율" />
              <Line type="monotone" dataKey="소진율" stroke="#3b82f6" strokeWidth={2} dot={{ r: 3 }} name="응대율" />
              <Line type="monotone" dataKey="부재율" stroke="#ef4444" strokeWidth={2} dot={{ r: 3 }} name="부재율" />
            </LineChart>
          </ResponsiveContainer>
        </div>
        <div>
